...
DEVICE_WIDTH = pygame.display.Info().current_w
DEVICE_HEIGHT = pygame.display.Info().current_h
DEVICE_SIZE = (DEVICE_WIDTH, DEVICE_HEIGHT)
DEVICE_CENTER = tuple([x//2 for x in DEVICE_SIZE])
